<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DashbordVendeur.aspx.cs" Inherits="Projet_ASP.DashbordVendeur"  EnableEventValidation="false" ValidateRequest="false"%>
            ...
            <div id="wrapper">
                ...
                <ul class="navbar-nav bg-gradient sidebar sidebar-dark accordion" id="accordionSidebar" style="background: linear-gradient(to top left, #e40d38 0%, #7e071b 100%);">
                    ...
                    <a class="sidebar-brand d-flex align-items-center justify-content-center" href="http://localhost:65470/DashbordVendeur.aspx">
                        ...
                        <div class="sidebar-brand-text mx-3"><img src="logo/sansback2.png" style="max-height:75px; max-width:175px;" /></div>
                    </a>
                    ...
                    <li class="nav-item">
                        <a class="nav-link collapsed" href="http://localhost:65470/MesColisVendeur.aspx"  data-target="#collapseUtilities" aria-expanded="true" aria-controls="collapseUtilities">
                    ...
                    <div id="content">
                        ...
                        <div class="container-fluid">
                            ...
                            <div class="row">
                                ...
                                <!-- Chaiffre d'affaire Card Example -->
                                <div class="col-xl-3 col-md-6 mb-4">
                                    <div class="card border-left-primary shadow h-100 py-2">
                                        <div class="card-body">
                                            <div class="row no-gutters align-items-center">
                                                <div class="col mr-2">
                                                    <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">Chaiffre D'affaire</div>
                                                    <asp:Label ID="Label2" runat="server" Text="Label" class="h5 mb-0 font-weight-bold text-gray-800">84506DH</asp:Label>
                                ...
                                <div class="col-xl-3 col-md-6 mb-4">
                                    <div class="card border-left-success shadow h-100 py-2">
                                        <div class="card-body">
                                            <div class="row no-gutters align-items-center">
                                                <div class="col mr-2">
                                                    <div class="text-xs font-weight-bold text-success text-uppercase mb-1">Livre</div>
                                                    <asp:Label ID="Label1" runat="server" Text="Label" class="h5 mb-0 font-weight-bold text-gray-800">164</asp:Label>  
                                                </div>
                                                <div class="col-auto">
                                ...
                                <div class="col-xl-3 col-md-6 mb-4">
                                    <div class="card border-left-danger shadow h-100 py-2">
                                        <div class="card-body">
                                            <div class="row no-gutters align-items-center">
                                                <div class="col mr-2">
                                                    <div class="text-xs font-weight-bold text-danger text-uppercase mb-1">Retourne</div>
                                                    <div class="row no-gutters align-items-center">
                                                        <div class="col-auto">
                                                            <asp:Label ID="Label4" runat="server" Text="Label" class="h5 mb-0 mr-3 font-weight-bold text-gray-800">40%</asp:Label>
                                ...
                                <!-- Non Reponse Card Example -->
                                <div class="col-xl-3 col-md-6 mb-4">
                                    <div class="card border-left-warning shadow h-100 py-2">
                                        <div class="card-body">
                                            <div class="row no-gutters align-items-center">
                                                <div class="col mr-2">
                                                    <div class="text-xs font-weight-bold text-warning text-uppercase mb-1">Non Réponse</div>
                                                    <asp:Label ID="Label3" runat="server" Text="Label" class="h5 mb-0 font-weight-bold text-gray-800">49</asp:Label>
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-footer">
                           ...
                           <%-- <asp:Button ID="Button1" runat="server" Text="Déconnecte" class="btn btn-danger" OnClick="Button1_Click" />--%>
